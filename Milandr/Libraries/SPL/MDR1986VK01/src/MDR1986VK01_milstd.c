...
#define ASSERT_INFO_FILE_ID FILEID__MDR1986VK01_MIL_STD1553_C
...
void MIL_STD_1553_CLK_en(uint32_t MIL_STD_1553_CLK_DIV)
{
	...
	assert_param(IS_MIL_STD_1553_DEVIDER(MIL_STD_1553_CLK_DIV));
...
*
* END OF FILE MDR1986VK01_milstd.c */
