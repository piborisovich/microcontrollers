...
void I2C_Init(const I2C_InitTypeDef* I2C_InitStruct)
{
    ...
    if ((I2C_InitStruct->I2C_Speed & I2C_CTR_S_I2C_Msk) != I2C_SPEED_UP_TO_400kHz) {
        TempCTR |= I2C_CTR_S_I2C;
    } else {
        TempCTR &= ~I2C_CTR_S_I2C;
    }
    ...
    TempPR       = I2C_InitStruct->I2C_ClkDiv;
    MDR_I2C->PRL = TempPR;
    MDR_I2C->PRH = TempPR >> 8;
}
 ...
 * @param  Direction - @ref I2C_Transfer_Direction_TypeDef - specifies whether
...
void I2C_Send7BitAddress(uint8_t Address, I2C_TransferDirection_TypeDef Direction)
{
    ...
    MDR_I2C->TXD = (uint32_t)((Address << 1) | Direction);
 ...
 * @param  Acknowledge - @ref I2C_M2S_Acknowledge_TypeDef - specifies
 ...
 *         @ref I2C_EVENTS in MDR32F23QI_i2c.h file.
