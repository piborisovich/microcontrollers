...
#ifndef __MDR32F23QI_I2C_H
#define __MDR32F23QI_I2C_H
 ...
 */
typedef enum {
    I2C_SPEED_UP_TO_400kHz = (((uint32_t)0x0) << I2C_CTR_S_I2C_Pos), /*!< I2C speed is up to 400 KHz. */
    I2C_SPEED_UP_TO_1MHz   = (((uint32_t)0x1) << I2C_CTR_S_I2C_Pos)  /*!< I2C speed is up to 1 MHz. */
} I2C_Speed_TypeDef;
...
#define IS_I2C_DIRECTION(DIRECTION) (((DIRECTION) == I2C_DIR_TRANSMITTER) || \
...
typedef struct
{
    ...
    I2C_Speed_TypeDef I2C_Speed; /*!< Specifies I2C speed limit.
                                      This parameter can be a value of @ref I2C_Speed_TypeDef. */
} I2C_InitTypeDef;
...
/** @} */ /* End of group I2C_Exported_Defines */
...
void    I2C_StartReceiveData(I2C_MasterToSlaveAcknowledge_TypeDef Acknowlage);
 ...
 *      could be compared to events already defined in the library (MDR32F23QI_i2c.h)
...
#endif /* __MDR32F23QI_I2C_H */

/*********************** (C) COPYRIGHT 2025 Milandr ****************************
 *
 * END OF FILE MDR32F23QI_i2c.h */
