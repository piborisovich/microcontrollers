 ...
 * @version V1.0.0
 * @date    22/05/2023
 * @brief   CMSIS Device Peripheral Access Layer System Source File for MDR32F23QI.
 ******************************************************************************
 * <br><br>
 *
...
#include "system_MDR32F23QI_config.h"
...
void SystemInit(void)
{
    ...
    /* Reset all clock but DEBUG_EN and RST_CLK bits */
